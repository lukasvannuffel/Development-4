// idealist.js - Certificate page for Idealist profile
document.addEventListener('DOMContentLoaded', function() {
  ...
  const idealistScore = parseInt(urlParams.get('idealist')) || 100;
  ...
  const content = {
    nl: {
      ...
      profileTitle: "De Idealist – De morele kompasdrager",
      description: "Deze persoon handelt vanuit principes. Eerlijkheid en rechtvaardigheid staan op de eerste plaats, zelfs als dat moeilijke beslissingen vereist. Of het nu gaat om eerlijk studeren, mensen helpen of idealen volgen, deze persoon kiest altijd voor het grotere goed.",
    ...
    en: {
      ...
      profileTitle: "The Idealist – The moral compass bearer",
      description: "This person acts based on principles. They put honesty and justice first, even if that means making difficult decisions. Whether it's studying honestly, helping people, or following their ideals, they always choose the greater good.",
  ...
  style.textContent = `
    ...
    .certificate::before {
      ...
      right: 0;
      bottom: 0;
      background: linear-gradient(135deg, rgba(102, 187, 106, 0.1) 0%, transparent 50%);
      z-index: 0;
    }
