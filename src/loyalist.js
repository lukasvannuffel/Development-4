// loyalist.js - Certificate page for Loyalist profile
document.addEventListener('DOMContentLoaded', function() {
  ...
  const loyalistScore = parseInt(urlParams.get('loyalist')) || 100;
  ...
  const content = {
    nl: {
      ...
      profileTitle: "De Loyalist – De beschermer van je groep",
      description: "Deze persoon kiest altijd voor vrienden en mensen om zich heen. Of het nu gaat om een huisgenoot, een vriend in nood of een moeilijke groepsopdracht – de prioriteit ligt bij loyaliteit en samenhorigheid. Deze persoon denkt na over wat het beste is voor de groep, zelfs als dat betekent dat eigen belangen soms opzij worden geschoven.",
    ...
    en: {
      ...
      profileTitle: "The Loyalist – The protector of your group",
      description: "This person always chooses friends and the people around them. Whether it's a roommate, a friend in need, or a difficult group assignment - their priority lies with loyalty and togetherness. They think about what's best for the group, even if it means their own interests sometimes take a back seat.",
  ...
  style.textContent = `
    ...
    .certificate::before {
      ...
      right: 0;
      bottom: 0;
      background: linear-gradient(135deg, rgba(66, 165, 245, 0.1) 0%, transparent 50%);
      z-index: 0;
    }
